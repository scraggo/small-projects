...
const dateStyle =
  '[style="font-size: 11px; font-weight: 400; color: rgb(136, 136, 136); padding-top: 0px; padding-bottom: 2px;"]';
const linkSelector = 'a.clickable';

const linkSections = document.querySelectorAll(linkSectionStyle);

// created 12/5/2019, ... -> 2019-12-05
