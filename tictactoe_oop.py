...
class Game:
    ...
    def testMove(self, letter, move):
        # make a copy of the board
        board_copy = self.board.getBoardCopy()
        # modify board copy
    ...
    def getComputerMove(self, computerLetter):
        ...
        for i in range(1, 10):
            if self.board.isSpaceFree(i) and self.testMove(computerLetter, i):
        ...
        for i in range(1, 10):
            if self.board.isSpaceFree(i) and self.testMove(playerLetter, i):
    ...
    while True:
        ...
        while gameIsPlaying:
            if turn == 'player':
                ...
                if t.isWinner(t.board.board, playerLetter):
                    t.board.drawBoard()
                    print('Hooray! You have won the game!')
                    gameIsPlaying = False
                else:
                    if t.board.isBoardFull():
                        t.board.drawBoard()
                ...
                if t.isWinner(t.board.board, computerLetter):
                    t.board.drawBoard()
